...
const SAMPLE_COMPONENTS: ComponentLibraryItem[] = [
    ...
    },
    {
        ...
        category: 'content',
        description: 'Microsoft Learn hero section layout',
        preview: <div className="atlas-hero-preview">
            <div className="hero-title">Hero Title</div>
            <div className="hero-subtitle">Hero description</div>
        </div>,
        defaultProps: { title: 'Hero Title', subtitle: 'Hero description', hasBackground: true },
        icon: '🎯'
    },
