...
const filePath = '/Users/carlosmarinburgos/designetica/backend/generateWireframeEnhanced/index.js';
...
try {
  ...
  console.log('   • Improved text colors (#323130 for primary, #605e5c for secondary)');
