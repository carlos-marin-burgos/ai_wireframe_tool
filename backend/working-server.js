...
try {
    ...
    console.log('⚠️ Could not load local.settings.json, using system environment variables');
}

const { generateHeroHTML, generateMicrosoftNavHTML, generateMicrosoftFooterHTML, HeroTemplates, detectHeroType, generateContextualHero } = require('./components/HeroGenerator');
...
app.post('/api/generateWireframe', async (req, res) => {
    try {
        ...
        const { generateWireframeFromDescription } = require('./generateWireframe/index.js');
        ...
        const response = {
            ...
            patternsLearned: result.patternsLearned || ['user-preference-modern', 'layout-grid'],
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Request: ${req.body.description || req.body.prompt || 'No description provided'}</p>
        </div>
        <div class="content">
            <div class="card">
