...
`,d=(t,i,a)=>{const e=o[a]||o.primary;return`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Microsoft Learn - ${t}</title>
    <style>
        ${n(e)}
        .hero { 
...
</html>`},l=(t,i,a)=>{const e=o[a]||o.primary;return`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`},c=(t,i,a)=>{const e=o[a]||o.primary;return`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`},p=(t,i,a)=>{const e=o[a]||o.primary;return`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`},g=(t,i,a)=>{const e=o[a]||o.primary;return`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`},h=[{condition:t=>/\b(landing|home|welcome|marketing|hero|main\s*page)\b/i.test(t),generator:d,category:"landing"},{condition:t=>/\b(dashboard|analytics|metrics|stats|overview|admin|control\s*panel)\b/i.test(t),generator:l,category:"dashboard"},{condition:t=>/\b(form|input|register|signup|contact|submit|survey)\b/i.test(t),generator:c,category:"form"},{condition:t=>/\b(article|blog|content|documentation|tutorial|guide|post)\b/i.test(t),generator:p,category:"content"}];function m(t){const{description:i,theme:a="microsoftlearn",colorScheme:e="primary"}=t;console.log("🔄 Generating client-side fallback wireframe:",{description:i.substring(0,50)+"...",theme:a,colorScheme:e});const r=h.find(s=>s.condition(i));return r?(console.log(`✅ Using ${r.category} template for fallback`),r.generator(i,a,e)):(console.log("📄 Using generic template for fallback"),g(i,a,e))}export{m as generateFallbackWireframe};
