...
/* Palette aligned with Microsoft Azure design */
:root {
  --wf-neutral-50: #f8f9fa;
  --wf-neutral-600: #e1e5e9;
  --wf-neutral-700: #d1d5db;
  --wf-neutral-900: #0069EC;
  --wf-blue-500: #0078d4;
  --wf-white: #ffffff;
  --wf-gray-50: #323130;
}
...
.wireframe-image {
  background: var(--wf-neutral-50) !important;
  border: 1px solid var(--wf-neutral-600) !important;
  border-radius: 4px;
  display: flex;
  align-items: center;
  justify-content: center;
