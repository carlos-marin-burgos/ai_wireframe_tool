...
- Use Microsoft Learn color scheme (#0078d4 primary)
...
module.exports = async function (context, req) {
  ...
  try {
    // Extract parameters
    const {
      prompt = "Microsoft Learn dashboard",
      description = prompt,
    ...
    // Generate wireframe
    const result = await generateAIWireframe(prompt, {
      projectType,
      fastMode,
