...
const fluentUIComponents = {
  components: [
    // Buttons
    {
      ...
      htmlCode: `<button style="background: #0078d4; color: white; border: none; padding: 8px 20px; border-radius: 4px; font-family: 'Segoe UI', sans-serif; font-weight: 600; cursor: pointer; font-size: 14px;">Primary Button</button>`,
    },
    {
      ...
      category: "Buttons",
      githubPath: "react-components/react-button",
      htmlCode: `<button style="background: transparent; color: #0078d4; border: 1px solid #0078d4; padding: 7px 19px; border-radius: 4px; font-family: 'Segoe UI', sans-serif; font-weight: 600; cursor: pointer; font-size: 14px;">Secondary Button</button>`,
    },
    {
      ...
      category: "Buttons",
      githubPath: "react-components/react-button",
      htmlCode: `<button style="background: transparent; color: #323130; border: none; padding: 8px 20px; border-radius: 4px; font-family: 'Segoe UI', sans-serif; font-weight: 600; cursor: pointer; font-size: 14px;">Subtle Button</button>`,
    },
    {
    ...
    },
    {
      ...
      category: "Buttons",
      githubPath: "react-components/react-button",
      htmlCode: `<button style="background: #f3f2f1; color: #323130; border: 1px solid #8a8886; padding: 8px 20px; border-radius: 4px; font-family: 'Segoe UI', sans-serif; font-weight: 600; cursor: pointer; font-size: 14px;">Toggle Button</button>`,
    },
    ...
    },
    {
      ...
      htmlCode: `<div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px; font-family: 'Segoe UI', sans-serif;"><input type="checkbox" id="checkbox1" style="margin: 0; width: 16px; height: 16px;" /><label for="checkbox1" style="color: #323130; cursor: pointer; font-size: 14px;">I agree to the terms and conditions</label></div>`,
    },
    {
    ...
    // Navigation Components
    {
      ...
      htmlCode: `<nav style="font-family: 'Segoe UI', sans-serif; font-size: 14px;"><ol style="list-style: none; padding: 0; margin: 0; display: flex; align-items: center;"><li><a href="#" style="color: #0078d4; text-decoration: none;">Home</a></li><li style="margin: 0 8px; color: #8a8886;">/</li><li><a href="#" style="color: #0078d4; text-decoration: none;">Category</a></li><li style="margin: 0 8px; color: #8a8886;">/</li><li style="color: #323130;">Current Page</li></ol></nav>`,
    },
    {
      id: "fluent-tab-list",
      name: "TabList",
      ...
      htmlCode: `<div style="font-family: 'Segoe UI', sans-serif;"><div style="display: flex; border-bottom: 1px solid #e1e5e9;"><button style="background: none; border: none; padding: 12px 16px; cursor: pointer; font-size: 14px; font-weight: 600; color: #0078d4; border-bottom: 2px solid #0078d4;">Tab 1</button><button style="background: none; border: none; padding: 12px 16px; cursor: pointer; font-size: 14px; color: #605e5c; border-bottom: 2px solid transparent;">Tab 2</button><button style="background: none; border: none; padding: 12px 16px; cursor: pointer; font-size: 14px; color: #605e5c; border-bottom: 2px solid transparent;">Tab 3</button></div><div style="padding: 20px 0;"><p style="margin: 0; color: #323130;">Content for Tab 1</p></div></div>`,
    },
    ...
    // Data Display
    {
      ...
      htmlCode: `<div style="width: 40px; height: 40px; border-radius: 50%; background: #0078d4; display: flex; align-items: center; justify-content: center; color: white; font-family: 'Segoe UI', sans-serif; font-weight: 600; font-size: 16px;">JD</div>`,
    },
    {
      id: "fluent-badge",
      name: "Badge",
    ...
    },
    {
      ...
      htmlCode: `<div style="font-family: 'Segoe UI', sans-serif; margin-bottom: 16px;"><div style="margin-bottom: 8px; font-weight: 600; color: #323130; font-size: 14px;">Progress: 60%</div><div style="width: 100%; max-width: 300px; height: 8px; background: #f3f2f1; border-radius: 4px; overflow: hidden;"><div style="width: 60%; height: 100%; background: #0078d4; transition: width 0.3s ease;"></div></div></div>`,
    },
    {
      id: "fluent-spinner",
      name: "Spinner",
    ...
    // Feedback Components
    {
      ...
      htmlCode: `<div style="background: #f3f9fd; border: 1px solid #cfe4fa; border-left: 4px solid #0078d4; padding: 12px 16px; border-radius: 4px; font-family: 'Segoe UI', sans-serif; margin-bottom: 16px;"><div style="display: flex; align-items: center; gap: 8px;"><span style="color: #004578; font-weight: 600; font-size: 14px;">Info</span><span style="color: #323130; font-size: 14px;">This is an informational message.</span></div></div>`,
    },
    {
      id: "fluent-toast",
      name: "Toast",
      ...
      htmlCode: `<div style="background: white; border: 1px solid #e1e5e9; border-radius: 8px; padding: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.15); font-family: 'Segoe UI', sans-serif; max-width: 300px;"><div style="display: flex; align-items: center; gap: 12px;"><div style="width: 4px; height: 40px; background: #107c10; border-radius: 2px;"></div><div><div style="font-weight: 600; color: #323130; font-size: 14px; margin-bottom: 4px;">Success!</div><div style="color: #605e5c; font-size: 14px;">Your action was completed successfully.</div></div></div></div>`,
    },
